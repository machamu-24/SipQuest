  ...
  return (
    <section className="reveal mx-auto w-full max-w-2xl">
      ...
      <header className="mb-5">
        <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-[#d4a843]">New Entry</p>
        <h1 className="mt-1 text-2xl font-bold tracking-tight text-white">新規記録</h1>
        <p className="mt-1 text-sm text-[#8b95a8]">飲んだお酒の情報を記録します。</p>
      </header>
